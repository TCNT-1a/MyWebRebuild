...
namespace MyApp.Web.Controllers
{
    public class TagsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Slug,isPublished,Id,CreatedDate,UpdatedDate,IsDeleted")] Tag tag)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,Slug,isPublished,Id,CreatedDate,UpdatedDate,IsDeleted")] Tag tag)
        {
            if (id != tag.Id)
            {
                return NotFound();
